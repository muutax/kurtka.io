...
class Records(models.Model):
    ...
    date_of_receipt = models.CharField(max_length=4  , verbose_name="Год поступления")
    date_of_release = models.CharField(max_length=4, verbose_name="Год выпуска")
    the_lvl = models.CharField(max_length=15, verbose_name="Уровень образования")
    direction_of_study = models.CharField(max_length=50, verbose_name="Направление обучения")
    phone_number = models.CharField(max_length=11, verbose_name="Телефон")
    e_mail = models.CharField(max_length=25, verbose_name="Email")
